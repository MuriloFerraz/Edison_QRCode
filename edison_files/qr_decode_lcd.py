...
## Hello!
write("Intel Edison", "#IntelMaker")
time.sleep(3)
write("OpenCV Version:", OpenCV_version)
time.sleep(3)
write("MRAA Version:", mraa_version)
time.sleep(3)
...
while True:
    ...
    for symbol in image:
        ...
        write(str(symbol.type), str(symbol.data))
